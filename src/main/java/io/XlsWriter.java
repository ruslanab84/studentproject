...
public class XlsWriter {
    ...
    public static void writeXlsStatistics(List<Statistics> statisticsList,
        ...
        for (Statistics statistics : statisticsList) {
            ...
            profileCell.setCellValue(statistics.getProfile());
            Cell avgScoreCell = dataRow.createCell(1);
            avgScoreCell.setCellValue(statistics.getAvgExamPoint());
            Cell numberOfStudentsCell = dataRow.createCell(2);
            numberOfStudentsCell.setCellValue(statistics.getStudentCountProfile());
            Cell numberOfUniversitiesCell = dataRow.createCell(3);
            numberOfUniversitiesCell.setCellValue(statistics.getUniversityCountProfile());
